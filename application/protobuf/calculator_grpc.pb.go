...
const (
	ArithmeticService_GetAddition_FullMethodName       = "/proto.arithmeticService/GetAddition"
	ArithmeticService_GetSubtraction_FullMethodName    = "/proto.arithmeticService/GetSubtraction"
	ArithmeticService_GetMultiplication_FullMethodName = "/proto.arithmeticService/GetMultiplication"
	ArithmeticService_GetDivision_FullMethodName       = "/proto.arithmeticService/GetDivision"
)
...
type ArithmeticServiceClient interface {
	GetAddition(ctx context.Context, in *Operators, opts ...grpc.CallOption) (*Msg, error)
	GetSubtraction(ctx context.Context, in *Operators, opts ...grpc.CallOption) (*Msg, error)
	GetMultiplication(ctx context.Context, in *Operators, opts ...grpc.CallOption) (*Msg, error)
	GetDivision(ctx context.Context, in *Operators, opts ...grpc.CallOption) (*Msg, error)
}
...
func (c *arithmeticServiceClient) GetAddition(ctx context.Context, in *Operators, opts ...grpc.CallOption) (*Msg, error) {
...
func (c *arithmeticServiceClient) GetSubtraction(ctx context.Context, in *Operators, opts ...grpc.CallOption) (*Msg, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Msg)
...
func (c *arithmeticServiceClient) GetMultiplication(ctx context.Context, in *Operators, opts ...grpc.CallOption) (*Msg, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Msg)
...
func (c *arithmeticServiceClient) GetDivision(ctx context.Context, in *Operators, opts ...grpc.CallOption) (*Msg, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Msg)
...
type ArithmeticServiceServer interface {
	GetAddition(context.Context, *Operators) (*Msg, error)
...
func (UnimplementedArithmeticServiceServer) GetAddition(context.Context, *Operators) (*Msg, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAddition not implemented")
}
func (UnimplementedArithmeticServiceServer) GetSubtraction(context.Context, *Operators) (*Msg, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSubtraction not implemented")
}
func (UnimplementedArithmeticServiceServer) GetMultiplication(context.Context, *Operators) (*Msg, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMultiplication not implemented")
}
func (UnimplementedArithmeticServiceServer) GetDivision(context.Context, *Operators) (*Msg, error) {
...
func _ArithmeticService_GetAddition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetAddition(ctx, req.(*Operators))
	}
...
func _ArithmeticService_GetSubtraction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetSubtraction(ctx, req.(*Operators))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ArithmeticService_GetMultiplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetMultiplication(ctx, req.(*Operators))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ArithmeticService_GetDivision_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetDivision(ctx, req.(*Operators))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArithmeticService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "application/protobuf/calculator.proto",
}
